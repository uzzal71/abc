...
if ($results->num_rows > 0) {
	...
	$sql = "INSERT INTO temp_humidity(device_id, circle_id, region_id, site_id, node_id, temp, humidity, date_time, status) 
	VALUES('$device_id', '$circle_id','$region_id','$site_id', '$node[$i]', '$temp[$i]', '$humidity[$i]', NOW(),'1')";				
